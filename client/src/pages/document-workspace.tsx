...
export default function DocumentWorkspace() {
  ...
  return (
    <div className="h-screen flex flex-col" style={{ background: 'linear-gradient(to bottom, #fcf2f7 0%, #f9f1f8 25%, #f8f4fc 50%, #f5f9ff 75%, #eef8fd 100%)' }}>
      ...
      <ResizablePanelGroup direction="horizontal" className="h-full">
        ...
        <ResizablePanel defaultSize={50} minSize={30}>
          <div className="h-full relative" style={{
            background: 'linear-gradient(to bottom, #fcf2f7 0%, #f9f1f8 25%, #f8f4fc 50%, #f5f9ff 75%, #eef8fd 100%)'
          }}>
